    ...
    ************************************/
    ...
    class HeatTransferFluidsList
    {
        ...
        public bool SetFluidListFromXMLString(string xml)
        {
            ...
            {
                AppHelper.ShowMessageBox("Deserialize XML: " + ex.Message);
                return false;
            }
        }
        ...
        {
            if (xmlPath[0] == '\\') xmlPath = xmlPath.Substring(1);
        ...
        */
        ...
        public partial class heatTransferFluidsListHeatTransferFluidTemperaturesList
        {
            ...
            private byte flashPointField;
            private ushort boilingPointField;
            private ushort autoIgnitionField;
